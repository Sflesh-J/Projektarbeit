    	...
    	<!-- Pagination Navigation -->
                    ...
                    <div class="pagination">
                        ...
                        <div class="pagination-controls">
                            <!-- Vorherige Seite -->
                            <% if (currentPage > 1) { %>
                                <a href="verlauf.jsp?page=<%= currentPage - 1 %>" class="btn btn-auswahl"><i class="arrow left"></i> Vorherige</a>
                            <% } else { %>
                            	<a href="" class="btn btn-auswahl"  ><i class="arrow left"></i> Vorherige</a>
							<% } %>
                            <!-- Seitenzahlen -->
                            ...
                            <% if (currentPage < totalPages) { %>
                                <a href="verlauf.jsp?page=<%= currentPage + 1 %>" class="btn btn-auswahl">Nächste <i class="arrow right"></i></a>
                            <% } else { %>
								<a href="" class="btn btn-auswahl"   >Nächste <i class="arrow right"></i></a>
							<% } %>
                        </div>
                    </div>
                    <% } %>
