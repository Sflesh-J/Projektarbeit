		...
		try {
			...
			resp.sendRedirect("index.jsp?isSuccess=1");
				...
				resp.sendRedirect("admin_user.jsp?uid=" + userToChange.getUid());
					...
					resp.sendRedirect("buchung_bearbeiten.jsp?uid=" + user.getUid() + "&buchungid=" +  buchungID + "&tablet=" + req.getParameter("tablet"));
				...
				if (itemW != null ){
					...
					throw new Exception("Keine Items ausgewählt");
				}
